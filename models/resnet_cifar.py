...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, dataset='cifar10', cfg=None):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.layer1 = self._make_layer(block, 16, n, cfg=self.cfg[0:n])
        self.layer2 = self._make_layer(block, 32, n, cfg=self.cfg[n:2*n], stride=2)
        self.layer3 = self._make_layer(block, 64, n, cfg=self.cfg[2*n:3*n], stride=2)
