...
parser.add_argument('--save', type=str, default='./result/ablation')
...
if __name__ == "__main__":
    ...
    # load model
    net = resnet(arch=args.arch).cuda()
    ...
    step = [[8]*layers[0], [16]*layers[1], [32]*layers[2], [64]*layers[3]]
    ...
    print_log('Finished !! Please update the optimal pruned result(resnet50) in pruned_arch.json', log)
